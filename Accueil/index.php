...
inner join n_enigme e on 
 e.num_enigme=ep.num_eni  inner join n_utilisateur u on u.num_utilisateur = e.id_createur  left outer join n_assoc_note_parc na on na.refParc =p.num_parcour  order by num_parcour ");
 ...
 //echo "</div>";
  ...
  echo"<div class='detail-box'>";
   ...
   echo" <div class='type'>";
     ...
     echo"<a href='#'>" .   htmlentities($row['titre_parcours']) . "</a>";
      echo "<p> réalisé par "    . $row['pseudo']   . "</p>";
      if ($row['note_donne'] != null) {
        echo "<p> noté "    . $row['note_donne']   . "/5</p>";
      }
      else {
